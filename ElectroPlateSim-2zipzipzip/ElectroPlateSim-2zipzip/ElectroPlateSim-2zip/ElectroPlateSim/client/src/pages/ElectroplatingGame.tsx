...
const translations = {
  en: {
    ...
    tutorial: {
      ...
      step4Desc: "The electron appears again at the negative (-) terminal. Drag it along the wire down to the copper ring (cathode).",
  ...
  ar: {
    ...
    tutorial: {
      ...
      step4Desc: "يظهر الإلكترون مجددا عند القطب السالب (-). اسحبه على طول السلك إلى حلقة النحاس (الكاثود).",
